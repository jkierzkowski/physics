...
* Differential equation solvers
  ...
  * Ginzburg–Landau equation solved using the Runge-Kutta methods

  * Sine-Gordon equation solved using the split-step Fourier method

* Lattice and statistical physics simulations

  * Lattice evolution algorithm modeling stone erosion

  * Quantum ideal gas simulations, including quantum Carnot and Otto cycles for Fermi and Bose gases
